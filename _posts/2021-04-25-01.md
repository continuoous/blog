...
summary: MS Excel functions like `=(MIN(MOD(A1,SEQUENCE(SQRT(A1),,2,1)))<>0)` are cryptic and hard to read. LET function un-nests such formulas to makes them intuitive and easier to read.
tags: [NoCode, Excel]
---
